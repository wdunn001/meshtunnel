...
The data plane uses **unreliable** Link packets (`create_receipt=False`) because the
...
- **Assign a stable synthetic source IP per identity.** This is for a service that is
...
| I2P interface        | 100s of ms to s | marginal       | yes                      |
